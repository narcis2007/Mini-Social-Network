...
public class AuthView extends VBox {
    ...
    private  ClientScris2Application app;
    ...
    public AuthView(ClientScris2Application app, Controller controller) {
    ...
    private final EventHandler<ActionEvent> authActionHandler= btnEvent->{
        ...
        if (authButtonText.equals(LOGIN)) {
            ...
            authService = controller.authService(usernameText, passwordText); // just a reference to an async call/task
